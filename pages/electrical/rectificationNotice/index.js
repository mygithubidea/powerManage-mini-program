...
Page({
    data: {
        ...
        TabCur: 0,
        showMenu: [
            wx.getStorageSync('menu').includes("rectificationNotice1"),
            wx.getStorageSync('menu').includes("rectificationNotice2"),
        ],
        showBtn: [
            wx.getStorageSync('menu').includes("rectificationNotice1add"),
            wx.getStorageSync('menu').includes("rectificationNotice2add"),
        ],
        dataList0: [],
        dataList1: [],
        searchParam0: {
    ...
    query(index, isRefresh) {
        ...
        queryData.level = Number(tdata.TabCur) + 2;
        getAppRectificationNoticePage(queryData,
            res => {
