import {
    getReportingOfHiddenDangersPage,
} from '../../../api/api.js';
Page({
    data: {
        refreshFlag: false,
        TabCur: 0,
        showMenu: [
            wx.getStorageSync('menu').includes("reportingOfHiddenDangers1"),
            wx.getStorageSync('menu').includes("reportingOfHiddenDangers2"),
            wx.getStorageSync('menu').includes("reportingOfHiddenDangers3"),
        ],
        dataList0: [],
        dataList1: [],
        searchParam0: {
    ...
    query(index, isRefresh) {
        ...
        getReportingOfHiddenDangersPage(index, queryData,
            res => {
