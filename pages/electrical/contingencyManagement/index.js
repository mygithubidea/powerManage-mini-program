...
Page({
    data: {
        ...
        TabCur: 0,
        showMenu: [
            wx.getStorageSync('menu').includes("contingencyManagement1"),
            wx.getStorageSync('menu').includes("contingencyManagement2"),
            wx.getStorageSync('menu').includes("contingencyManagement3"),
        ],
        showBtn: [
            wx.getStorageSync('menu').includes("contingencyManagement1add"),
            wx.getStorageSync('menu').includes("contingencyManagement2add"),
            wx.getStorageSync('menu').includes("contingencyManagement3add"),
        ],
        dataList0: [],
        dataList1: [],
        searchParam0: {
    ...
    query(index, isRefresh) {
        ...
        getContingencyManagementPage(index, queryData,
            res => {
