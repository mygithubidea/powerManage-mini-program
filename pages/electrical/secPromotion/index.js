...
Page({
    data: {
        ...
        TabCur: 0,
        showMenu: [
            wx.getStorageSync('menu').includes("secPromotion1"),
            wx.getStorageSync('menu').includes("secPromotion2"),
            wx.getStorageSync('menu').includes("secPromotion3"),
        ],
        showBtn: [
            wx.getStorageSync('menu').includes("secPromotion1add"),
            wx.getStorageSync('menu').includes("secPromotion2add"),
            wx.getStorageSync('menu').includes("secPromotion3add"),
        ],
        dataList0: [],
        dataList1: [],
        dataList2: [],
    ...
    query(index, isRefresh) {
        ...
        getAppSafetyPromotionPage(queryData,
            res => {
