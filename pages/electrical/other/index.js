...
Page({
    data: {
        ...
        TabCur: 0,
        showMenu: [
            wx.getStorageSync('menu').includes("other1"),
            wx.getStorageSync('menu').includes("other2"),
            wx.getStorageSync('menu').includes("other3"),
        ],
        showBtn: [
            wx.getStorageSync('menu').includes("other1add"),
            wx.getStorageSync('menu').includes("other2add"),
            wx.getStorageSync('menu').includes("other3add"),
        ],
        dataList0: [],
        dataList1: [],
        searchParam0: {
    ...
    query(index, isRefresh) {
        ...
        getAppOtherTablePage(queryData,
            res => {
